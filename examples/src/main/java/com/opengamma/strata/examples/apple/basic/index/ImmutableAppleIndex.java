...
public class ImmutableAppleIndex implements AppleIndex, ImmutableBean, Serializable {
  ...
  @PropertyDefinition(validate = "notNull")
  private final int MaturityDateAdjustment;


  @PropertyDefinition(validate = "notNull")
  private final DaysAdjustment calendar;
  ...
  protected ImmutableAppleIndex(ImmutableAppleIndex.Builder builder) {
    ...
    JodaBeanUtils.notNull(builder.MaturityDateAdjustment, "MaturityDateAdjustment");
    JodaBeanUtils.notNull(builder.calendar, "calendar");
    this.name = builder.name;
    this.currency = builder.currency;
    this.location = builder.location;
    this.grade = builder.grade;
    this.MaturityDateAdjustment = builder.MaturityDateAdjustment;
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets the MaturityDateAdjustment.
   * @return the value of the property, not null
   */
  public int getMaturityDateAdjustment() {
    return MaturityDateAdjustment;
  }
   ...
   * @return the value of the property, not null
   */
  public DaysAdjustment getCalendar() {
    return calendar;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(name, other.name) &&
          ...
          (grade == other.grade) &&
          (MaturityDateAdjustment == other.MaturityDateAdjustment) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(MaturityDateAdjustment);
  ...
  protected void toString(StringBuilder buf) {
    ...
    buf.append("MaturityDateAdjustment").append('=').append(JodaBeanUtils.toString(MaturityDateAdjustment)).append(',').append(' ');
  ...
  public static class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code MaturityDateAdjustment} property.
     */
    private final MetaProperty<Integer> MaturityDateAdjustment = DirectMetaProperty.ofImmutable(
        this, "MaturityDateAdjustment", ImmutableAppleIndex.class, Integer.TYPE);
    /**
     * The meta-property for the {@code calendar} property.
     */
    private final MetaProperty<DaysAdjustment> calendar = DirectMetaProperty.ofImmutable(
        this, "calendar", ImmutableAppleIndex.class, DaysAdjustment.class);
    /**
     * The meta-properties.
     */
    ...
    protected MetaProperty<?> metaPropertyGet(String propertyName) {
      switch (propertyName.hashCode()) {
        ...
        case 98615255:  // grade
          return grade;
        case 63225292:  // MaturityDateAdjustment
          return MaturityDateAdjustment;
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<Integer> MaturityDateAdjustment() {
      return MaturityDateAdjustment;
    }
     ...
     * @return the meta-property, not null
     */
    public final MetaProperty<DaysAdjustment> calendar() {
      return calendar;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 63225292:  // MaturityDateAdjustment
          return ((ImmutableAppleIndex) bean).getMaturityDateAdjustment();
        case -178324674:  // calendar
  ...
  public static class Builder extends DirectFieldsBeanBuilder<ImmutableAppleIndex> {
    ...
    private int grade;
    private int MaturityDateAdjustment;
    private DaysAdjustment calendar;
    ...
    protected Builder(ImmutableAppleIndex beanToCopy) {
      ...
      this.MaturityDateAdjustment = beanToCopy.getMaturityDateAdjustment();
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case 98615255:  // grade
          ...
          break;
        case 63225292:  // MaturityDateAdjustment
          this.MaturityDateAdjustment = (Integer) newValue;
          break;
        case -178324674:  // calendar
          this.calendar = (DaysAdjustment) newValue;
          break;
        default:
          throw new NoSuchElementException("Unknown property: " + propertyName);
      }
    ...
    /**
     * Sets the MaturityDateAdjustment.
     * @param MaturityDateAdjustment  the new value, not null
     * @return this, for chaining, not null
     */
    public Builder MaturityDateAdjustment(int MaturityDateAdjustment) {
      JodaBeanUtils.notNull(MaturityDateAdjustment, "MaturityDateAdjustment");
      this.MaturityDateAdjustment = MaturityDateAdjustment;
      return this;
    }
     ...
     * @return this, for chaining, not null
     */
    public Builder calendar(DaysAdjustment calendar) {
